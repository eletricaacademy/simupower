...
## Asset pipeline
- GLB servido como **arquivo separado** em `/public/models` (sem base64).
- Documente um script gltf-transform (resize de textura, webp, weld, quantize; Draco/meshopt opcional).
