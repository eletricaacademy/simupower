...
export const spdaProcedure: TestProcedure = {
  ...
  steps: [
    ...
    },
    {
      ...
      vista: { pos: [-7.8, 1.51, -6.5], target: [-7.15, 0.31, -5.25] },
    },
    {
      id: 'spda-medir',
      titulo: 'Medir entre descidas e até o BEP',
      descricao:
        'Meça os pares vizinhos D1–D2, D2–D3, D3–D4 e D4–D1: primeiro nos terminais superiores e depois nos inferiores. Repita nas cruzadas D1–D3 e D2–D4. Finalize com D1–BEP na sala elétrica.',
      detalhes: [
        'Seccionamentos abertos: uma garra em cada caixa; superiores pelo caminho da captação, inferiores pelo anel de aterramento',
        ...
        'Registre as 12 medições entre descidas e a medição D1–BEP; restaure os seccionamentos após o ensaio real',
      ],
      cuidados: ['A medição inferior verifica continuidade dos condutores, não a resistência do eletrodo em relação ao solo.', 'Sala elétrica: QGBT fechado; acesso e condições de segurança conforme APR/NR-10.'],
